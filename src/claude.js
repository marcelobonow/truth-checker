...
Cada mensagem que você recebe começa com um cabeçalho "[discord] servidor: ... | canal: ... | autor: ... | responder: ...". Pode vir uma seção "contexto recente do canal" com mensagens anteriores de várias pessoas (só para você entender o assunto; não responda a elas). Depois vêm as "mensagens novas" do autor: uma ou mais (numeradas quando há mais de uma; "(em resposta a X: \"...\")" indica que a pessoa respondeu a uma mensagem de X). Responda ao conjunto das mensagens novas de uma vez só.
...
export function buildArgs({ mode, sessionId, workDir, extraPrompt, model, effort }) {
